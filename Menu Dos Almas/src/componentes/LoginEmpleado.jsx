        ...
        <div className="md:w-1/2 px-8">
          ...
          <form className="flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              <svg
                ...
                height="16"
                fill="currentColor"
                className="absolute top-1/2 right-3 -z-1 -translate-y-1/2 cursor-pointer hidden"
                id="mama"
                viewBox="0 0 16 16"
              >
                ...
                <path d="M5.525 7.646a2.5 2.5 0 0 0 2.829 2.829l-2.83-2.829z" />
              </svg>
            </div>
          ...
          <button className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 hover:bg-[#60a8bc4f] font-medium">
            <svg
              ...
              width="25px"
            >
              <path fill="#FFC107" d="M43.611,20.083H24v8h11.303..." />
            </svg>
            Login with Google
          </button>
          ...
          <div className="mt-4 text-sm flex justify-between items-center">
            ...
            <button className="text-white bg-[#002D74] rounded-xl py-2 px-5 hover:scale-110 duration-300">
              Register
            </button>
          </div>
        </div>
